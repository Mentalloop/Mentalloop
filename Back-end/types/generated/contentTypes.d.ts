...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    conteudos: Schema.Attribute.Relation<
      'manyToMany',
    ...
    > &
      Schema.Attribute.Private;
    nome_categoria: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiConteudoConteudo extends Struct.CollectionTypeSchema {
...
export interface ApiEmpresaEmpresa extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    colaboradors: Schema.Attribute.Relation<
      'oneToMany',
      'api::colaborador.colaborador'
    >;
    createdAt: Schema.Attribute.DateTime;
